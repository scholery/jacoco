...
clientJarPath=/opt/client/org.jacoco.cli-0.8.12-SNAPSHOT-nodeps.jar
jacocoExecFilePath=/opt/jacocoReport/execFile
jacocoHtmlReportPath=/opt/jacocoReport/htmlReport
##xmlReport路径必须已存在，否则生成报告时候会报错
jacocoTestCommonPath=/opt/jacoco-test/common
jacocoTestJava8Path=/opt/jacoco-test/java8
