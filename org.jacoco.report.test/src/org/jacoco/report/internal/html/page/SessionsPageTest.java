...
public class SessionsPageTest extends PageTestBase {
	...
	public void testExecutionDataContent() throws Exception {
		...
		data.add(new ExecutionData(0x1000, "ClassB", TraceValue.get(),
				new boolean[0]));
		data.add(new ExecutionData(0x1001, "ClassC", TraceValue.get(),
				new boolean[0]));
		data.add(new ExecutionData(0x1002, "ClassA", TraceValue.get(),
				new boolean[0]));
